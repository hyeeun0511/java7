...
//===============================================
// # 인터페이스
// - ' List, Set, Map ' 인터페이스의 메서드 
// - List : 순서 있음O, 중복 허용O
// => 입력 출력만 가능할수있도록
// - Set : 순서 없음X, 중복 허용안함X
// - Map : (key,value)키와 값으로 이루어진 쌍, 키는 중복 허용안함X, 값은 중복 허용O
//         여러 리스트를 묶어서 관리 => 그룹핑
//         주로 hash map 사용
//===============================================
// 순서있는것만 for문 작성 가능             
//===============================================
// # ArrayList(배열)
// 장점 : 1) 간단한 구조 / 2) 데이터 읽는 시간(접근시간) ↓
// 단점 : 1) 비순차적인 데이터의 추가,삭제 시간 ↑ / 2) 타입고정 / 3) 크기 변경 불가 -> 크기 변경 : 더큰 배열 생성 -> 기존 배열 복사 -> 새로운 배열 사용
// * ArrayList에서 삭제 for문
// 1) for(int i=list.size()-1;i>=0;i--) {}
// - 뒤에서부터 앞으로 삭제
// - 배열을 새롭게 만들어서 새롭게 진행
// ---컬렉션 
//    장점 : 객체 넣을 수 있음 / 크기 변경 가능
// (  # LinkedList (이중 연결 리스트)  )    
// (  : 데이터 추가,삭제 시간 ↓  )
//===============================================
// # 스택 & 큐 
// 스택 : LIFO구조. 마지막에 저장된것을 제일 먼저 꺼내게 된다. (장바구니에 물건담고, 마지막에 넣은 물건이 제일 먼저 나오는것)
//       : Last In First Out(마지막에 넣은 물건이 제일 먼저 나옴)
//===============================================
...
// - 읽어오기, 출력 방법 : System.out.println(map.get("key"));
//===========================================
// # [ Generics ] - 제너릭(지네릭스) 
// - < >에 데이터 값 넣으면 그 타입만 담음
// - 선언 : ArrayList<Stuscore> list = new ArrayList();  -> Stuscore 타입만 담음
// - 장점 : 형변환을 하지않아도 됨
//===========================================
// # 열거형 (enum) 
// 
//===========================================
// # 애너테이션 - @ Overide
// 자동 Overide : Alt + Shift + S → Override/Implement Methods > 목록에서 toString() 선택
//===========================================
// # 입출력과 스트림
// : 입출력(I/O) - Input(입력)/Output(출력)
// 
// 
// 
// 
